...
namespace TimeToGo.ViewBox
{
    ...
    public sealed partial class Viewbox : ContentControl
    {
        ...
        /// <see cref="T:TimeToGo.ViewBox.Viewbox" /> element.
        /// </summary>
        /// <value>
        ...
        /// <summary>
        /// Identifies the
        /// <see cref="P:TimeToGo.ViewBox.Viewbox.Stretch" />
        /// dependency property.
        /// </summary>
        /// <value>
        /// The identifier for the
        /// <see cref="P:TimeToGo.ViewBox.Viewbox.Stretch" /> dependency
        /// property.
        /// </value>
        ...
        private static void OnStretchPropertyChanged(DependencyObject d, DependencyPropertyChangedEventArgs e)
        {
            ...
            if (!IsValidStretchValue(e.NewValue))
            {
                ...
                string message = string.Format(
                    ...
                    ViewBox.Resources.Viewbox_OnStretchPropertyChanged_InvalidValue,
                    e.NewValue);
        ...
        /// <summary>
        /// Identifies the
        /// <see cref="P:TimeToGo.ViewBox.Viewbox.StretchDirection" />
        /// dependency property.
        /// </summary>
        /// <value>
        /// The identifier for the
        ...
        private static void OnStretchDirectionPropertyChanged(DependencyObject d, DependencyPropertyChangedEventArgs e)
        {
            ...
            if (!IsValidStretchDirectionValue(e.NewValue))
            {
                ...
                string message = string.Format(
                    CultureInfo.InvariantCulture,
                    ViewBox.Resources.Viewbox_OnStretchDirectionPropertyChanged_InvalidValue,
                    e.NewValue);
                throw new ArgumentException(message, "e");
            }
        ...
        /// <see cref="T:TimeToGo.ViewBox.Viewbox" /> class.
        /// </summary>
        public Viewbox()
        {
        ...
        /// <see cref="T:TimeToGo.ViewBox.Viewbox" /> control when a new
        /// template is applied.
        /// </summary>
        public override void OnApplyTemplate()
        {
            ...
            {
                throw new InvalidOperationException(ViewBox.Resources.Viewbox_OnApplyTemplate_OnlyOnce);
            }
